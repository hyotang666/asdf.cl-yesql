...
(in-package :asdf)
;; Enable testing via (asdf:test-system "asdf.cl-yesql").
(defmethod component-depends-on
           ((o test-op) (c (eql (find-system "asdf.cl-yesql"))))
  (append (call-next-method) '((test-op "asdf.cl-yesql.test"))))
...
(let ((system (find-system "jingoh.documentizer" nil)))
  (when system
    ...
    (defmethod perform :after
               ((o load-op) (c (eql (find-system "asdf.cl-yesql"))))
